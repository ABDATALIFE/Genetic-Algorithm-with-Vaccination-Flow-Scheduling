...
function [newvaccinatedphenotypes1] = Filtering(newphenotype1)
...
vaccinatedpheno = newphenotype1(:,1);
...
vaccinatedpheno2 = newphenotype1(:,2);
...
vaccinatedpheno3 = newphenotype1(:,3);
