...
[phenopheno phenopheno2 phenopheno3] =Filtering1(phenonewtypes1);
phenopheno = sort(phenopheno,'ascend');
phenopheno2 = sort(phenopheno2,'ascend');
phenopheno3 = sort(phenopheno3,'ascend')
phenonewtypesaftervaccine = [phenopheno(1:100) phenopheno2(1:100) phenopheno3(1:100)];
